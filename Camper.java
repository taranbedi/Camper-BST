...
public class Camper implements Comparable<Camper> {
  ...
  /**
   * Constructor that sets the firstName, and LastName on the camper class
   * 
   * @param firstName, the first name of the Camper
   * @param lastName, the last name of the Camper
   */
  ...
  public int compareTo(Camper camper) {
    // create two strings that concat the last name and first name
    String a = lastName + ", " + firstName;
    String b = camper.getLastName() + ", " + camper.getFirstName();
